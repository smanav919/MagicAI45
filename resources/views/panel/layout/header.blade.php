...
>
    <svg
        class="translate-x-0 translate-y-0 transition-transform group-hover:-translate-x-[2px] group-[.navbar-shrinked]/body:-scale-x-100 group-[.navbar-shrinked]/body:group-hover:translate-x-[2px] rtl:-scale-x-100 rtl:group-[.navbar-shrinked]/body:scale-x-100"
        ...
        <div class="container-fluid p-0 max-lg:w-full">
            <h1
                ...
                >
                    ...
                    <!-- collapsed -->
                    <img
                        class="mx-auto hidden h-auto w-full max-w-[40px] group-[.navbar-shrinked]/body:block dark:!hidden"
                        src="/{{ $setting->logo_collapsed_path }}"
                        @if (isset($setting->logo_collapsed_2x_path)) srcset="/{{ $setting->logo_collapsed_2x_path }} 2x" @endif
                        alt="{{ $setting->site_name }}"
                    >
                    <img
                        class="mx-auto hidden h-auto w-full max-w-[40px] group-[.theme-dark.navbar-shrinked]/body:block"
                ...
                <ul class="primary-nav navbar-nav max-lg:px-3 max-lg:py-4">
                    <li>
                        <div class="nav-link-label transition-all">
                            <span class="inline-block rounded-[3px] px-[0.5em] py-[0.35em] text-[10px] font-medium uppercase tracking-widest">
                                {{ __('User') }}
                            </span>
                        </div>
                    </li>
                    <li class="nav-item">
                        <a
                            class="nav-link {{ activeRoute('dashboard.user.index') }}"
                    ...
                    <li class="nav-item">
                        <a
                            class="nav-link {{ activeRoute('dashboard.user.openai.documents.*') }}"
                    ...
                    @if ($setting->feature_ai_writer)
                        <li class="nav-item">
                            <a
                                class="nav-link {{ activeRoute('dashboard.user.openai.list', 'dashboard.user.openai.generator.*') }}"
                    ...
                    @if ($setting->feature_ai_image)
                        <li class="nav-item">
                            <a
                                class="nav-link {{ route('dashboard.user.openai.generator', 'ai_image_generator') == url()->current() ? 'active' : '' }}"
                    ...
                    @if ($setting->feature_ai_article_wizard)
                        <li class="nav-item">
                            <a
                                class="nav-link {{ route('dashboard.user.openai.articlewizard.new') == url()->current() ? 'active' : '' }}"
                    ...
                    @if ($setting->feature_ai_pdf)
                        <li class="nav-item">
                            <a
                                class="nav-link {{ route('dashboard.user.openai.generator.workbook', 'ai_pdf') == url()->current() ? 'active' : '' }}"
                    ...
                    @if ($setting->feature_ai_vision)
                        <li class="nav-item">
                            <a
                                class="nav-link {{ route('dashboard.user.openai.generator.workbook', 'ai_vision') == url()->current() ? 'active' : '' }}"
                    ...
                    @if ($setting->feature_ai_rewriter)
                        <li class="nav-item">
                            <a
                                class="nav-link {{ activeRoute('dashboard.user.openai.rewriter') }}"
                                ...
                                <span class="nav-link-icon">
                                    ...
                                    >
                                        <g clip-path="url(#clip0_3749_192)">
                                            <path
                                                d="M12.8335 5.5L19.2502 11.9167L15.5835 15.5833"
                                                stroke-width="1.5"
                                                stroke-linecap="round"
                                                stroke-linejoin="round"
                                            />
                                            ...
                                            />
                                            <path
                                                d="M3.6665 18.3333L5.28717 16.7126"
                                                stroke-width="1.5"
                                                stroke-linecap="round"
                                                stroke-linejoin="round"
                                            />
                    ...
                    @if ($setting->feature_ai_chat_image)
                        <li class="nav-item">
                            <a
                                class="nav-link {{ route('dashboard.user.openai.generator.workbook', 'ai_chat_image') == url()->current() ? 'active' : '' }}"
                    ...
                    @if ($setting->feature_ai_chat)
                        <li class="nav-item">
                            <a
                                class="nav-link {{ activeRoute('dashboard.user.openai.chat.list', 'dashboard.user.openai.chat.chat') }}"
                    ...
                    @if ($setting->feature_ai_code)
                        <li class="nav-item">
                            <a
                                class="nav-link {{ route('dashboard.user.openai.generator.workbook', 'ai_code_generator') == url()->current() ? 'active' : '' }}"
                    ...
                    @if ($setting->feature_ai_youtube)
                        <li class="nav-item">
                            <a
                                class="nav-link {{ route('dashboard.user.openai.generator.workbook', 'ai_youtube') == url()->current() ? 'active' : '' }}"
                    ...
                    @if ($setting->feature_ai_rss)
                        <li class="nav-item">
                            <a
                                class="nav-link {{ route('dashboard.user.openai.generator.workbook', 'ai_rss') == url()->current() ? 'active' : '' }}"
                    ...
                    @includeWhen(view()->exists('panel.admin.custom.user.header-menu'), 'panel.admin.custom.user.header-menu')

                    @if ($setting->feature_ai_speech_to_text)
                        <li class="nav-item">
                            <a
                                class="nav-link {{ route('dashboard.user.openai.generator', 'ai_speech_to_text') == url()->current() ? 'active' : '' }}"
                    ...
                    @if ($setting->feature_ai_voiceover)
                        <li class="nav-item">
                            <a
                                class="nav-link {{ route('dashboard.user.openai.generator', 'ai_voiceover') == url()->current() ? 'active' : '' }}"
                    ...
                    @php
                        $checkPlan = \App\Models\PaymentPlans::query()
                            ->where('is_team_plan', 1)
                            ->first();
                    @endphp

                    @if (
                        $setting->team_functionality &&
                            !auth()->user()->getAttribute('team_id') &&
                            $checkPlan)
                        <li class="nav-item">
                            <a
                                class="nav-link {{ activeRoute('dashboard.user.team.*') }}"
                    ...
                    @if ($setting->feature_affilates)
                        <li class="nav-item">
                            <a
                                class="nav-link {{ activeRoute('dashboard.user.affiliates.index') }}"
                    ...
                    <li class="nav-item">
                        <a
                            class="nav-link {{ activeRoute('dashboard.support.*') }}"
                    ...
                    <li>
                        <a
                            class="nav-link {{ activeRoute('dashboard.user.openai.list.favorites') }}"
                    ...
                    <li>
                        <a
                            class="nav-link {{ activeRoute('dashboard.user.openai.documents.all') }}"
                            href="{{ route('dashboard.user.openai.documents.all') }}"
                        >
                            <span
                    ...
                    @if (Auth::user()->type == 'admin')
                        ...
                        <li class="nav-item">
                            <a
                                class="nav-link {{ activeRoute('dashboard.admin.index') }}"
                        ...
                        <li class="nav-item">
                            <a
                                class="nav-link {{ activeRoute('dashboard.admin.users.*') }}"
                        ...
                        <li class="nav-item">
                            <a
                                class="nav-link {{ activeRoute('dashboard.admin.ads.*') }}"
                        ...
                        <li class="nav-item">
                            ...
                            >
                                ...
                                <span class="nav-link-title flex grow items-center transition-[opacity,transform]">{{ __('Support Requests') }}
                                </span>
                            </a>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            <a
                                class="nav-link dropdown-toggle {{ activeRouteBulk('dashboard.admin.openai.list', 'dashboard.admin.openai.custom.list', 'dashboard.admin.openai.chat.list', 'dashboard.admin.openai.chat.*', 'dashboard.admin.openai.categories.list', 'dashboard.admin.openai.categories.*') }}"
                            ...
                            <div
                                class="dropdown-menu {{ activeRouteBulkShow('dashboard.admin.openai.list', 'dashboard.admin.openai.custom.list', 'dashboard.admin.openai.custom.*', 'dashboard.admin.openai.chat.list', 'dashboard.admin.openai.chat.*', 'dashboard.admin.openai.categories.list', 'dashboard.admin.openai.categories.*', 'dashboard.email-templates.list') }}">
                                <a
                                    class="dropdown-item {{ activeRoute('dashboard.admin.openai.list') }}"
                                    href="{{ route('dashboard.admin.openai.list') }}"
                                >
                                    {{ __('Built-in Templates') }}
                                </a>
                                <a
                                    class="dropdown-item {{ activeRoute('dashboard.admin.openai.custom.*') }}"
                                    href="{{ route('dashboard.admin.openai.custom.list') }}"
                                >
                                    {{ __('Custom Templates') }}
                                </a>
                                <a
                                    class="dropdown-item {{ activeRoute('dashboard.admin.openai.categories.list', 'dashboard.admin.openai.categories.*') }}"
                                    href="{{ route('dashboard.admin.openai.categories.list') }}"
                                >
                                    {{ __('AI Writer Categories') }}
                                </a>
                                <a
                                    class="dropdown-item {{ activeRoute('dashboard.admin.openai.chat.category', 'dashboard.admin.openai.chat.addOrUpdateCategory') }}"
                                    href="{{ route('dashboard.admin.openai.chat.category') }}"
                                >
                                    {{ __('Chat Categories') }}
                                </a>
                                <a
                                    class="dropdown-item {{ activeRoute('dashboard.admin.openai.chat.list', 'dashboard.admin.openai.chat.addOrUpdate') }}"
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div
                                ...
                                <a
                                    class="dropdown-item {{ activeRoute('dashboard.admin.frontend.settings') }}"
                                    href="{{ route('dashboard.admin.frontend.settings') }}"
                                >
                                    {{ __('Frontend Settings') }}
                                </a>
                                <a
                                    class="dropdown-item {{ activeRoute('dashboard.admin.frontend.sectionsettings') }}"
                                    href="{{ route('dashboard.admin.frontend.sectionsettings') }}"
                                >
                                    {{ __('Frontend Section Settings') }}
                                </a>
                                <a
                                    class="dropdown-item {{ activeRoute('dashboard.admin.frontend.menusettings') }}"
                                    href="{{ route('dashboard.admin.frontend.menusettings') }}"
                                >
                                    {{ __('Menu') }}
                                </a>
                                <a
                                    class="dropdown-item {{ activeRoute('dashboard.admin.frontend.faq.*') }}"
                                    href="{{ route('dashboard.admin.frontend.faq.index') }}"
                                >
                                    {{ __('F.A.Q') }}
                                </a>
                                <a
                                    class="dropdown-item {{ activeRoute('dashboard.admin.frontend.tools.*') }}"
                                    href="{{ route('dashboard.admin.frontend.tools.index') }}"
                                >
                                    {{ __('Tools Section') }}
                                </a>
                                <a
                                    class="dropdown-item {{ activeRoute('dashboard.admin.frontend.future.*') }}"
                                    href="{{ route('dashboard.admin.frontend.future.index') }}"
                                >
                                    {{ __('Features Section') }}
                                </a>
                                <a
                                    class="dropdown-item {{ activeRoute('dashboard.admin.testimonials.*') }}"
                                    href="{{ route('dashboard.admin.testimonials.index') }}"
                                >
                                    {{ __('Testimonials Section') }}
                                </a>
                                <a
                                    class="dropdown-item {{ activeRoute('dashboard.admin.clients.*') }}"
                                    href="{{ route('dashboard.admin.clients.index') }}"
                                >
                                    {{ __('Clients Section') }}
                                </a>
                                <a
                                    class="dropdown-item {{ activeRoute('dashboard.admin.howitWorks.*') }}"
                                    href="{{ route('dashboard.admin.howitWorks.index') }}"
                                >
                                    {{ __('How it Works Section') }}
                                </a>
                                <a
                                    class="dropdown-item {{ activeRoute('dashboard.admin.frontend.whois.*') }}"
                                ...
                                <a
                                    class="dropdown-item {{ activeRoute('dashboard.admin.frontend.generatorlist.*') }}"
                        ...
                        <li class="nav-item dropdown">
                            <a
                                class="nav-link dropdown-toggle {{ activeRouteBulk('dashboard.admin.finance.*') }}"
                                data-bs-toggle="dropdown"
                                data-bs-auto-close="false"
                                href="#navbar-help"
                                role="button"
                            ...
                            <div class="dropdown-menu {{ activeRouteBulkShow('dashboard.admin.finance.*') }}">
                                ...
                                <a class="dropdown-item {{ activeRoute('dashboard.admin.bank.transactions.list') }}"
                                    ...
                                    <span class="nav-link-title flex grow items-center transition-[opacity,transform]">{{ __('Bank Transactions') }}</span>
                                    <span class="flex !h-5 !w-5 items-center justify-center rounded-full bg-[#F3E2FD] text-xs text-black">{{ countBankTansactions() }}</span>
                                </a>
                                @endif
                                <a
                                    class="dropdown-item {{ activeRoute('dashboard.admin.finance.plans.*') }}"
                                    href="{{ route('dashboard.admin.finance.plans.index') }}"
                                >
                                    {{ __('Membership Plans') }}
                                </a>
                                <a
                                    class="dropdown-item {{ activeRoute('dashboard.admin.finance.paymentGateways.*') }}"
                                ...
                                @if ($setting->mobile_payment_active)
                                    <a
                                        class="dropdown-item {{ activeRoute('dashboard.admin.finance.mobile.index') }}"
                        ...
                        <li class="nav-item">
                            <a
                                class="nav-link {{ activeRoute('dashboard.page.*') }}"
                        ...
                        <li class="nav-item">
                            <a
                                class="nav-link {{ activeRoute('dashboard.blog.*') }}"
                        ...
                        <li class="nav-item">
                            <a
                                class="nav-link {{ activeRoute('dashboard.admin.affiliates.*') }}"
                        ...
                        <li class="nav-item">
                            <a
                                class="nav-link {{ activeRoute('dashboard.admin.coupons.*') }}"
                        ...
                        <li class="nav-item">
                            <a
                                class="nav-link {{ activeRoute('dashboard.email-templates.*') }}"
                        ...
                        <li class="nav-item dropdown">
                            <a
                                class="nav-link dropdown-toggle {{ activeRouteBulk('dashboard.admin.settings.general', 'dashboard.admin.settings.invoice', 'dashboard.admin.settings.payment', 'dashboard.admin.settings.openai', 'dashboard.admin.settings.affiliate') }}"
                                data-bs-toggle="dropdown"
                                data-bs-auto-close="false"
                                href="#navbar-help"
                                role="button"
                            ...
                            <div
                                ...
                                <a
                                    class="dropdown-item {{ activeRoute('dashboard.admin.settings.general') }}"
                                    href="{{ route('dashboard.admin.settings.general') }}"
                                >
                                    {{ __('General') }}
                                </a>
                                <a
                                    class="dropdown-item {{ activeRoute('dashboard.admin.settings.invoice') }}"
                                ...
                                <a
                                    class="dropdown-item {{ activeRoute('dashboard.admin.settings.openai') }}"
                                    href="{{ route('dashboard.admin.settings.openai') }}"
                                >
                                    {{ __('OpenAI') }}
                                </a>
                                <a
                                    class="dropdown-item {{ activeRoute('dashboard.admin.settings.stablediffusion') }}"
                                    href="{{ route('dashboard.admin.settings.stablediffusion') }}"
                                >
                                    {{ __('StableDiffusion') }}
                                </a>
                                <a
                                    class="dropdown-item {{ activeRoute('dashboard.admin.settings.unsplashapi') }}"
                                    href="{{ route('dashboard.admin.settings.unsplashapi') }}"
                                >
                                    {{ __('Unsplash API') }}
                                </a>
                                <a
                                    class="dropdown-item {{ activeRoute('dashboard.admin.settings.serperapi') }}"
                                    href="{{ route('dashboard.admin.settings.serperapi') }}"
                                >
                                    {{ __('Serper API') }}
                                </a>
                                <a
                                    class="dropdown-item {{ activeRoute('dashboard.admin.settings.tts') }}"
                                    href="{{ route('dashboard.admin.settings.tts') }}"
                                >
                                    {{ __('TTS') }}
                                </a>
                                <a
                                    class="dropdown-item {{ activeRoute('dashboard.admin.settings.affiliate') }}"
                                    href="{{ route('dashboard.admin.settings.affiliate') }}"
                                >
                                    {{ __('Affiliate') }}
                                </a>
                                <a
                                    class="dropdown-item {{ activeRoute('dashboard.admin.settings.smtp') }}"
                                    href="{{ route('dashboard.admin.settings.smtp') }}"
                                >
                                    {{ __('SMTP') }}
                                </a>
                                <a
                                    class="dropdown-item {{ activeRoute('dashboard.admin.settings.gdpr') }}"
                                    href="{{ route('dashboard.admin.settings.gdpr') }}"
                                >
                                    {{ __('GDPR') }}
                                </a>
                                <a
                                    class="dropdown-item {{ activeRoute('dashboard.admin.settings.privacy') }}"
                                    href="{{ route('dashboard.admin.settings.privacy') }}"
                                >
                                    {{ __('Privacy Policy and Terms') }}
                                </a>
                                <a
                                    class="dropdown-item {{ activeRoute('elseyyid.translations.home') }} {{ activeRoute('elseyyid.translations.lang') }}"
                                    href="{{ LaravelLocalization::localizeUrl(route('elseyyid.translations.home')) }}"
                                >
                                    {{ __('Languages') }}
                                </a>
                                <a
                                    class="dropdown-item {{ activeRoute('dashboard.admin.settings.storage') }}"
                        ...
                        <li class="nav-item">
                            <a
                                class="nav-link {{ activeRoute('dashboard.admin.health.index') }} !pe-2"
    ...
    <header class="navbar navbar-expand-md navbar-light relative flex max-lg:h-[65px]">
        <div class="container-xl flex-nowrap !items-stretch">
            <div class="hidden items-center max-lg:flex max-lg:gap-3">
                <button
                    class="navbar-toggler collapsed max-lg:!block"
                ...
                <a
                    class="hidden shrink-0 items-center justify-center max-lg:flex max-md:max-w-[120px] lg:px-2"
                    href="{{ LaravelLocalization::localizeUrl(route('dashboard.index')) }}"
                >
                    <img
                        class=""
                ...
                <div class="flex gap-[18px] max-lg:gap-2">
                    <div class="flex items-center max-xl:gap-2 max-lg:hidden xl:gap-3">
                        ...
                        @endif
                            ...
                            >
                                <svg
                                    class="max-lg:h-[20px] max-lg:w-[20px] md:me-2"
                                    width="11"
                                    height="15"
                                    viewBox="0 0 11 15"
                                    fill="currentColor"
                    ...
                    <div class="flex items-center">
                        <a
                            class="nav-link hide-theme-dark items-center justify-center px-0 hover:!bg-transparent max-lg:h-10 max-lg:w-10 max-lg:!rounded-full max-lg:border max-lg:border-solid max-lg:border-[--tblr-border-color] max-lg:p-0 max-lg:dark:bg-white max-lg:dark:bg-opacity-[0.03]"
                            href="?theme=dark"
                        ...
                        <a
                            class="nav-link hide-theme-light items-center justify-center px-0 hover:!bg-transparent max-lg:h-10 max-lg:w-10 max-lg:!rounded-full max-lg:border max-lg:border-solid max-lg:border-[--tblr-border-color] max-lg:p-0 max-lg:dark:bg-white max-lg:dark:bg-opacity-[0.03]"
                            href="?theme=light"
                    ...
                    @if (count(explode(',', $settings_two->languages)) > 1)
                        <div class="nav-item dropdown">
                            <a
                                class="nav-link px-0 hover:!bg-transparent max-lg:h-10 max-lg:w-10 max-lg:!rounded-full max-lg:border max-lg:border-solid max-lg:border-[--tblr-border-color] max-lg:p-0 max-lg:dark:bg-white max-lg:dark:bg-opacity-[0.03]"
                                data-bs-toggle="dropdown"
                                href="#"
                                tabindex="-1"
                                ...
                                <div class="flex flex-col">
                                    @foreach (LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                                        @if (in_array($localeCode, explode(',', $settings_two->languages)))
                                            <a
                                                class="text-heading flex items-center border-l-0 border-r-0 border-t-0 border-solid border-[--tblr-border-color] px-3 py-2 transition-colors last:border-b-0 hover:bg-[--tblr-border-color] hover:no-underline"
                                                rel="alternate"
                                                hreflang="{{ $localeCode }}"
                                                href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}"
                                            >
                                                <span class="!me-2 text-[21px]">{{ country2flag(substr($properties['regional'], strrpos($properties['regional'], '_') + 1)) }}
                    ...
                    <div class="hidden items-center max-lg:flex">
                        <a
                            class="inline-flex h-10 w-10 items-center justify-center !rounded-full border border-solid !border-[--tblr-border-color] p-0 text-current dark:bg-white dark:bg-opacity-[0.03]"
                            href="{{ route('dashboard.user.payment.subscription') }}"
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div class="nav-item dropdown">
                        ...
                        >
                            ...
                            <span
                                class="avatar avatar-sm max-lg:h-10 max-lg:w-10"
                                style="background-image: url({{ !Auth::user()->github_token && !Auth::user()->google_token && !Auth::user()->facebook_token ? '/' : '' }}{{ Auth::user()->avatar }})"
                            ></span>
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <div class="dropdown-divider"></div>
                            <a
                                class="dropdown-item {{ activeRoute('dashboard.user.payment.subscription') }}"
                                href="{{ route('dashboard.user.payment.subscription') }}"
                            >
                                {{ __('Plan') }}
                            </a>
                            <a
                                class="dropdown-item {{ activeRoute('dashboard.user.orders.index') }}"
                                href="{{ route('dashboard.user.orders.index') }}"
                            >
                                {{ __('Orders') }}
                            </a>
                            <a
                                class="dropdown-item {{ activeRouteBulk('dashboard.user.settings.index') }}"
            ...
            <div class="flex items-center max-lg:fixed max-lg:bottom-16 max-lg:left-0 max-lg:z-50 max-lg:w-full lg:-order-1">
                <form
                ...
                >
                    <div class="input-icon w-full max-lg:bg-[#fff] max-lg:p-3 max-lg:dark:bg-zinc-800">
                        ...
                        <div
                            class="navbar-search-results absolute !start-0 top-[calc(100%+17px)] hidden max-h-[380px] w-[100%] overflow-y-auto rounded-md bg-[#fff] shadow-[0_10px_70px_rgba(0,0,0,0.1)] group-[.done-searching]:block dark:!bg-[--tblr-bg-surface] max-lg:bottom-full max-lg:end-0 max-lg:start-0 max-lg:top-auto max-lg:w-auto"
                            id="search_results"
                            style="z-index: 999;"
                        >
                            <!-- Search results here -->
                            <h3 class="m-0 border-b border-l-0 border-r-0 border-t-0 border-solid border-[--tblr-border-color] px-3 py-[0.75rem] text-[1rem] font-medium">
    ...
    <ul class="m-0 grid w-full list-none grid-cols-4 place-items-center p-0">
        ...
        <li class="w-full">
            <button
                ...
                data-bs-toggle="collapse"
                data-bs-target="#navbar-templates"
                type="button"
                aria-controls="navbar-templates"
                aria-expanded="false"
            ...
            >
                ...
                >
                    <svg
                        class="relative rotate-[135deg] transition-transform duration-300 group-[.collapsed]:rotate-0"
                        xmlns="http://www.w3.org/2000/svg"
                        width="20"
                        height="20"
                        viewBox="0 0 24 24"
...
<div
    class="group collapse fixed bottom-16 right-0 z-50 max-h-[calc(85vh-4rem)] w-full overflow-y-auto overscroll-contain rounded-t-2xl bg-[#fff] shadow-[-5px_-10px_30px_rgba(0,0,0,0.07)] dark:bg-zinc-800 lg:!hidden"
    id="navbar-templates"
>
...
<div class="group fixed bottom-20 end-12 z-50 hidden lg:block">
    <button
    ...
    >
        ...
        >
            <svg
                class="relative transition-transform duration-300 group-hover:rotate-[135deg]"
                xmlns="http://www.w3.org/2000/svg"
                width="23"
                height="23"
                viewBox="0 0 24 24"
    ...
    <div
        class="text-heading !invisible absolute bottom-full end-0 !mb-4 min-w-[145px] translate-y-2 rounded-md bg-[--tblr-body-bg] text-sm font-medium !opacity-0 shadow-[0_3px_12px_rgba(0,0,0,0.08)] transition-all before:absolute before:inset-x-0 before:-bottom-4 before:h-4 group-hover:!visible group-hover:translate-y-0 group-hover:!opacity-100 dark:bg-zinc-800"
        id="add-new-floating"
    >
        <span
            class="text-heading block border-b border-l-0 border-r-0 border-t-0 border-solid !border-black !border-opacity-5 !px-4 !py-2 text-opacity-50 last:border-0 dark:!border-white dark:!border-opacity-5"
        >{{ __('Items:') }}</span>
        <ul class="m-0 list-none p-0">
            @if ($setting->feature_ai_writer)
                <li class="border-b border-l-0 border-r-0 border-t-0 border-solid !border-black !border-opacity-5 last:border-0 dark:!border-white dark:!border-opacity-5">
                    <a
...
{{-- @includeWhen(in_array($settings_two->chatbot_status, ['dashboard', 'both']), 'panel.chatbot.widget') --}}
