...
<div class="page-body pt-6">
	<div class="container-xl">
		<div class="row col-md-5 mx-auto">
			<form class="@if(view()->exists('panel.admin.custom.layout.panel.header-top-bar')) bg-[--tblr-bg-surface] px-8 py-10 rounded-[--tblr-border-radius] @endif" id="settings_form" onsubmit="return generalSettingsSave();" enctype="multipart/form-data">
				...
				<div class="mb-[20px]">
					<label class="form-check form-switch">
						<input class="form-check-input" type="checkbox" id="limit" name="limit" {{ $settings_two?->daily_limit_enabled ?  'checked' : '' }}>
						<span class="form-check-label">{{ __('Apply daily limit on image generation') }}</span>
					</label>
				</div>

				<div class="mb-[20px]" id="countField" style="{{  $settings_two?->daily_limit_enabled ? '' : 'display:none' }}">
					<label class="form-label">{{ __('Daily Image Limit Count') }}</label>
					<input type="text" class="form-control" id="daily_limit_count" name="daily_limit_count" value="{{ $settings_two?->allowed_images_count }}">
				</div>


				<div class="mb-[20px]">
					<label class="form-check form-switch">
						<input class="form-check-input" type="checkbox" id="voice_limit" name="voice_limit" {{ $settings_two?->daily_voice_limit_enabled ?  'checked' : '' }}>
						<span class="form-check-label">{{ __('Apply daily limit on voice generation') }}</span>
					</label>
				</div>

				<div class="mb-[20px]" id="voiceCountField" style="{{  $settings_two?->daily_voice_limit_enabled ? '' : 'display:none' }}">
					<label class="form-label">{{ __('Daily Voice Limit Count') }}</label>
					<input type="text" class="form-control" id="daily_voice_limit_count" name="daily_voice_limit_count" value="{{ $settings_two?->allowed_voice_count }}">
				</div>
				...
				<div class="row mb-4">
					<div class="mb-3">
						...
						<label class="form-check form-switch">
							<input class="form-check-input" type="checkbox" id="feature_ai_vision" {{ $setting->feature_ai_vision ? 'checked' : '' }}>
							<span class="form-check-label">{{ __('AI Vision') }}</span>
						</label>
						<label class="form-check form-switch">
							<input class="form-check-input" type="checkbox" id="feature_ai_chat_image" {{ $setting->feature_ai_chat_image ? 'checked' : '' }}>
							<span class="form-check-label">{{ __('Chat Image') }}</span>
						</label>
						<label class="form-check form-switch">
							<input class="form-check-input" type="checkbox" id="feature_ai_pdf" {{ $setting->feature_ai_pdf ? 'checked' : '' }}>
							<span class="form-check-label">{{ __('AI PDF') }}</span>
						</label>
						<label class="form-check form-switch">
							<input class="form-check-input" type="checkbox" id="feature_ai_rewriter" {{ $setting->feature_ai_rewriter ? 'checked' : '' }}>
							<span class="form-check-label">{{ __('AI Rewriter') }}</span>
						</label>
						<label class="form-check form-switch">
							<input class="form-check-input" type="checkbox" id="feature_ai_youtube" {{ $setting->feature_ai_youtube ? 'checked' : '' }}>
							<span class="form-check-label">{{ __('AI YouTube') }}</span>
						</label>
						<label class="form-check form-switch">
							<input class="form-check-input" type="checkbox" id="feature_ai_rss" {{ $setting->feature_ai_rss ? 'checked' : '' }}>
							<span class="form-check-label">{{ __('AI RSS') }}</span>
						</label>
						<label class="form-check form-switch">
							<input class="form-check-input" type="checkbox" id="team_functionality" {{ $setting->team_functionality ? 'checked' : '' }}>
							<span class="form-check-label">{{ __('Team Functionality') }}</span>
						</label>
					</div>
				</div>

				<h3 class="mb-[25px] text-[20px]">{{__('Mobile Settings')}}</h3>
				<div class="row mb-4">
					<div class="mb-3">
						<div class="form-label">{{ __('This setting is in early alpha stage. Please do not activate until offically released.') }}</div>
						<label class="form-check form-switch">
							<input class="form-check-input" type="checkbox" id="mobile_payment_active" {{ $setting->mobile_payment_active ? 'checked' : '' }}>
							<span class="form-check-label">{{ __('Mobile Payment') }}</span>
						</label>
					</div>
				</div>
