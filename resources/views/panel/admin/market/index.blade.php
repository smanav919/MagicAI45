        ...
        <div class="container-xl">
            <div class="flex flex-wrap justify-start relative">
                @foreach ($extensions as $extension)
                    <div class="extension rounded-[20px] border-[1px] border-[#f3f3f3] w-[350px] border-solid m-2 flex flex-col p-[30px] hover:shadow-md relative"
                        ...
                        <div class="img_tag w-[53px] h-[53p] rounded-[10px] flex items-center">
                            ...
                            <div class="flex mx-3 items-center {{ $extension->installed == 1 ? '' : 'hidden' }}">
                                ...
                                <p class="mx-1 text-[14px] font-medium text-black m-0">Installed</p>
                            </div>
                        </div>
