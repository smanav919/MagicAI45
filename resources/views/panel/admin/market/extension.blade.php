...
@section('content')
    ...
    <div class="page-body pt-6">
        <div class="container-xl">
            <div class="flex">
                <div
                    class="w-[100%] relative mx-[15px] shadow-[0_4px_44px_0_rgba(113,136,197,0.07)] rounded-[20px] flex flex-col">
                    <div class="m-3">
                        <img src="{{ $extension->image_url }}" class="w-[89px] h-[89px]">
                    </div>
                    <div class="m-3 flex items-center">
                        <p class="text-[23px] font-semibold text-black m-0">Mailchimp</p>
                        <p class="text-[12px] font-medium text-[#3C344B] flex items-center mx-3 my-0"><svg width="12"
                    ...
                    <div class="m-3 flex items-center">
                        <div class="flex items-center">
                            ...
                            <p class="text-[15px] font-medium text-[#354D6E] mx-1 my-0">Tested with MagicAI</p>
                        </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <p class="text-[15px] font-medium text-[#354D6E] mx-1 my-0">
                        ...
                        <div class="flex items-center">
                            ...
                            <p class="text-[15px] font-medium text-[#354D6E] mx-1 my-0">Recently Updated</p>
                        </div>
                    </div>
                    <div class="m-3 flex items-center">
                        <p class="text-[23px] font-semibold text-black m-0">{{ __('About this add-on') }}</p>
                    </div>
                    <div class="m-3 flex items-center">
                        <div class="text-[15px] leading-6 font-normal text-[#595959] m-0 ">
                    ...
                    <div class="m-3 flex flex-col">
                        ...
                        @foreach ($tags as $tag)
                            <div class="flex">
                                ...
                                <p class="text-[#272D38] mx-2 text-[16px] font-normal leading-5"> {{ $tag }} </p>
                            </div>
                        @endforeach
                    </div>
                    <div class="m-3 flex flex-col">
                        <p class="text-[#002033] font-semibold text-[21px]"> {{ __('Have a question?') }} </p>
                        @foreach ($extensionQAs as $extensionQA)
                            <div
                                ...
                                <p class="text-[15px] text-[#595959] font-normal mr-[50px] custom-accordion-body">
                                    {{ $extensionQA['answer'] }}
                                </p>
                            </div>
                        @endforeach
                ...
                <div class="mx-[15px] min-w-[360px] max-w-[360px] flex flex-col">
                    <div class="flex flex-col rounded-[11px] border-[1px] border-solid border-[#f9f9f9] bg-white p-4">
                        <p
                            class="text-[16px] font-semibold text-[#002033] border-b-[1px] border-b-solid border-b-[#fafafa]">
                            Limited Offer</p>
                        <div class="flex items-center justify-between">
                            <p class="text-[36px] font-semibold text-black my-0">${{ $extension->price }}</p>
                            <p class="line-through text-[28px] font-semibold text-black opacity-25 my-0 hidden">$65</p>
                        ...
                        <div class="flex justify-center">
                            <p class="text-black opacity-50 text-[12px] font-medium py-2">
                    ...
                    <div class="flex flex-col rounded-[11px] border-[1px] border-solid border-[#f9f9f9] bg-white p-4">
                        ...
                        <div class="flex items-center justify-between flex-wrap">
                            <div
                                class="flex flex-col w-[45%] px-[18px] py-[12px] rounded-[11px] border-[1px] border-solid border-[#F8F8F8] my-2">
                                <p class="text-[#64748B] text-[10px] font-semibold">FREE UPDATES</p>
                                <p class="text-[#334155] text-[14px] font-semibold mt-3 mb-1">Lifetime</p>
                            </div>
                            <div
                                class="flex flex-col w-[45%] px-[18px] py-[12px] rounded-[11px] border-[1px] border-solid border-[#F8F8F8] my-2">
                                <p class="text-[#64748B] text-[10px] font-semibold">SUPPORT</p>
                                <p class="text-[#334155] text-[14px] font-semibold mt-3 mb-1">6 months</p>
                            </div>
                            <div
                                class="flex flex-col w-[45%] px-[18px] py-[12px] rounded-[11px] border-[1px] border-solid border-[#F8F8F8] my-2">
                                <p class="text-[#64748B] text-[10px] font-semibold">LICNESE</p>
                                <p class="text-[#334155] text-[14px] font-semibold mt-3 mb-1">Extended</p>
                            </div>
                            <div
                                class="flex flex-col w-[45%] px-[18px] py-[12px] rounded-[11px] border-[1px] border-solid border-[#F8F8F8] my-2">
                                <p class="text-[#64748B] text-[10px] font-semibold">INSTALLATION</p>
                                <p class="text-[#334155] text-[14px] font-semibold mt-3 mb-1">One Click</p>
                            </div>
                        </div>
                    </div>
                </div>
