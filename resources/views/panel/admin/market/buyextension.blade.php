    ...
    <div class="page-body pt-6">
        <div class="container-xl">
            <div class="flex flex-col flex-wrap items-center justify-center relative">
                <p class="font-semibold text-[23px] text-black">Select a payment method</p>
                <p class="font-bold text-[15px] text-[#485061] max-w-[350px] text-center">
                ...
                <div class="flex items-start flex-col my-2">
                    ...
                    <div
                        class="flex flex-col w-[350px] rounded-[13px] border-[2px] border-solid border-[#f9f9f9] p-3 m-1 text-[#212121]">
                        <div class="flex justify-between">
                            <p class="m-0">Add-on</p>
                            <p class="m-0">{{ $extension->name }}</p>
                        </div>
                        <div class="w-full h-[1px] bg-[#f9f9f9] my-2"></div>
                        <div class="flex justify-between">
                            <p class="m-0">Total: </p>
                            <p class="m-0 text-[21px]">${{ $extension->price }}</p>
                        </div>
                    </div>
                </div>
...
@section('script')
    ...
    <script>
        var stripe = Stripe('{{ env('EXTENSION_STRIPE_PUBLIC_KEY') }}');
