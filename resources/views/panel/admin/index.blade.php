			...
			<div class="col-lg-6">
				<div class="card">
					...
					<div class="card-body w-full !grow-0 mt-auto">
						...
						<div class="chart-navigation flex items-center gap-1 absolute top-2 end-2">
							<button type="button" id="btnPreviousMonth" class="inline-flex w-7 h-7 items-center justify-center border-none bg-none  dark:bg-white/10 dark:text-white">
								<svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M5 12l14 0" /><path d="M5 12l6 6" /><path d="M5 12l6 -6" /></svg>
							</button>
							<button type="button" id="btnNextMonth" class="inline-flex w-7 h-7 items-center justify-center border-none bg-none  dark:bg-white/10 dark:text-white">
								<svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M5 12l14 0" /><path d="M13 18l6 -6" /><path d="M13 6l6 6" /></svg>
							</button>
						</div>
					</div>
...
<script>
	(() => {
		...
		stroke: {
			width: 1,
			colors: ['var(--tblr-body-bg)', 'var(--tblr-body-bg)']
		},
		legend: {
			position: 'top',
