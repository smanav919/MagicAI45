<div
    class="row invite-a-friend mt-4"
    id="invite-a-friend"
>
    <div class="col-lg-6">
        <div class="card text-heading">
            <div class="card-body mb-3 flex flex-col px-8 py-6">
                ...
                <p>
                    @lang('Adding and overseeing team members with MagicAI is a straightforward process. Here\'s a quick example to initiate collaboration within seconds.')
                </p>
            </div>
            <div class="card-body flex flex-col px-8 py-6">
                <ol class="mb-3 ml-0 mt-4 list-none p-0">
                    <li class="mb-[18px]">
                        <span class="text-primary me-[1em] inline-flex h-[26px] w-[26px] items-center justify-center rounded-2xl bg-[rgba(var(--tblr-primary-rgb),0.2)]">
                            <svg
                                width="8"
                                height="12"
                                viewBox="0 0 8 12"
            ...
            <div class="card-body flex flex-col p-4 px-8 py-6">
                <ul>
                    <li>
                        <a href="#">
                            <img
                                class="h-auto w-full"
                                src="{{ asset('images/team/icon2.png') }}"
                                alt=""
                            >
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="#">
                            <img
                                class="h-auto w-full"
                                src="{{ asset('images/team/icon3.png') }}"
                                alt=""
                            >
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img
                                class="h-auto w-full"
                                src="{{ asset('images/team/icon4.png') }}"
                                alt=""
                            >
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img
                                class="h-auto w-full"
                                src="{{ asset('images/team/icon5.png') }}"
                                alt=""
                            >
                        </a>
                    </li>
                ...
                >
                    ...
                    <div class="relative flex items-center">
                        <input
                            class="form-control @error('email') is-invalid @enderror h-10"
                            id="email"
                            type="email"
                            name="email"
                        ...
                        <span class="absolute !end-0 top-0 flex h-full items-center px-3">
                            ...
                            >
                                <g clip-path="url(#clip0_253_1239)">
                                    ...
                                    ></path>
                                    <path
                                        d="M2.75 6.41669L11 11.9167L19.25 6.41669"
                                        stroke="currentColor"
                                        stroke-width="1.4"
                                        stroke-linecap="round"
                                        stroke-linejoin="round"
                    ...
                    @if ($app_is_demo)
                        <a
                            class="btn btn-primary w-100 mt-2 rounded-[10px]"
                            onclick="return toastr.info('This feature is disabled in Demo version.')"
                        >@lang('Invite Friends')</a>
                    @else
                        <button
                            class="btn btn-primary w-100 mt-2 rounded-[10px]"
                            type="submit"
                        >@lang('Invite Friends')</button>
                    @endif
