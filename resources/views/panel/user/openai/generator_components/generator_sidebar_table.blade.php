        ...
        <div class="col-6 col-md-4 col-xl-2 mb-8">
            <div class="image-result group">
                <div class="relative aspect-square rounded-lg mb-2 overflow-hidden group-hover:shadow-lg transition-all">
                    ...
                    <div
                        class="flex items-center justify-center gap-2 w-full h-full absolute top-0 left-0 opacity-0 transition-opacity group-hover:!opacity-100">
                        ...
                        <a data-fslightbox="gallery" href=""
                            class="btn lb items-center justify-center w-9 h-9 p-0 gallery" data-type="image">
                        ...
                        <a href="" onclick="return confirm('Are you sure?')"
                            class="btn items-center justify-center w-9 h-9 p-0 delete">
                ...
                <p class="w-full overflow-ellipsis whitespace-nowrap text-heading mb-1 overflow-hidden" title="">
                </p>
            ...
            <tbody>
                @foreach ($userOpenai as $entry)
                    ...
                    <tr class="text-[13px]">
                        ...
                        <td class="text-[11px]">
                            <span
                                class="inline-block bg-black/[0.06] px-[6px] py-[3px] rounded-sm dark:bg-white/[0.06]">
                        ...
                        <td>
                            <a href="/uploads/{{ $entry->output }}" target="_blank"
                                class="btn relative z-10 w-[36px] h-[36px] p-0 border hover:bg-[var(--tblr-primary)] hover:text-white"
                            ...
                            <a href="{{ LaravelLocalization::localizeUrl(route('dashboard.user.openai.documents.image.delete', $entry->slug)) }}"
                                onclick="return confirm('Are you sure?')"
                                class="btn relative z-10 p-0 border w-[36px] h-[36px] hover:bg-red-600 hover:text-white"
                                title="{{ __('Delete') }}">
                ...
                fetch(
                    ...
                    .then(data => {
                        ...
                        images.forEach(image => {
                            ...
                            imageResultTemplate.querySelector('.image-result a.download').setAttribute(
                                'href', image.output);
                            imageResultTemplate.querySelector('.image-result a.gallery').setAttribute(
                                'href', image.output);
